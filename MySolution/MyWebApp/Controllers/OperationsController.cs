...
namespace MyWebApp.Controllers
{
    ...
    {
        public static OperationAuthorizationRequirement Open = new OperationAuthorizationRequirement { Name = "Open" };
        public static OperationAuthorizationRequirement TakeCookie = new OperationAuthorizationRequirement { Name = "TakeCookie" };
        public static OperationAuthorizationRequirement ComeNear = new OperationAuthorizationRequirement { Name = "ComeNear" };
        public static OperationAuthorizationRequirement Look = new OperationAuthorizationRequirement { Name = "Look" };
    }
